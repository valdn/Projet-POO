...
class ImageD : public FormeD, public fm::Image {
	...
	////////////////////////////////////////////////////////////
	/// \var uint largeur
	/// \brief largeur l'ImageD
	///
	////////////////////////////////////////////////////////////

	////////////////////////////////////////////////////////////
	/// \var uint hauteur
	/// \brief hauteur de l'ImageD
	///
	////////////////////////////////////////////////////////////

	////////////////////////////////////////////////////////////
	/// \var int transparence
	/// \brief gère la transparence de l'image
	///
	////////////////////////////////////////////////////////////
	uint largeur, hauteur, transparence;

	protected:
		////////////////////////////////////////////////////////////
		/// \brief Ecris les données nécessaire du ImageD
	...
	public:
		...
		////////////////////////////////////////////////////////////
		/// \brief Retourne la valeur de la transparence de l'ImageD
		/// \return uint transparence
		///
		////////////////////////////////////////////////////////////
		inline uint getTransparence() const { return transparence; }


		////////////////////////////////////////////////////////////
		/// \brief Modifie la transparence de l' ImageD
		/// \param uint value, la valeur de la transparence
		/// \return void 
		///
		////////////////////////////////////////////////////////////
		void setTransparence(uint value);
