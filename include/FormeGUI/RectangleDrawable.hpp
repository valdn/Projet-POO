...
* \brief Classe pour définir un fm::Rectangle graphiquement sur SFML
* \authors DI NARDO Valentin, LENHARD Erwan
* \version 1.0
* \date 11 juin 2019
*/

class RectangleD : public FormeD, public fm::Rectangle {

	protected:
		////////////////////////////////////////////////////////////
		/// \brief Ecris les données nécessaire du RectangleD
